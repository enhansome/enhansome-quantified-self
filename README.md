...
# [<img src="https://cdn.rawgit.com/willempienaar/awesome-quantified-self/master/awesome-quantified-self.png">](https://github.com/willempienaar/awesome-quantified-self) ⭐ 2,768 | 🐛 42 | 📅 2026-07-06
...
* [BiomarkerDash](https://github.com/NoTranslationLayer/biomarkerdash) ⭐ 25 | 🐛 5 | 🌐 Python | 📅 2023-11-17 - Simple dashboard to visualize trends in bloodwork biomarkers.
* [Bloodboy](https://github.com/ashugaev/bloodboy-biomarkers-tracker) ⭐ 20 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-30 - Biomarker analyzer that extracts lab results from PDFs, converts units, and visualizes trends.
...
* [Garmin AI Notifier](https://github.com/deep0410/garmin-ai-notifier) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Free daily pipeline that pulls Garmin Connect into SQLite, computes full-history wellness stats, generates a Gemini-written brief, and pushes it to your phone via ntfy, Telegram, or email. Runs on GitHub Actions.
...
* [AirwayLab](https://github.com/airwaylab-app/airwaylab) ⭐ 35 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-13 - Browser-based PAP therapy analysis with flow limitation scoring and an oximetry pipeline. All processing runs locally (Web).
...
* [Firefly III](https://github.com/firefly-iii/firefly-iii) ⭐ 24,479 | 🐛 169 | 🌐 PHP | 📅 2026-09-01 - A free and open source personal finance manager
* [Ledger](https://github.com/ledger/ledger) ⭐ 6,024 | 🐛 19 | 🌐 C++ | 📅 2026-08-28 - Simple but powerful command line accounting.
* [ezBookkeeping](https://github.com/mayswind/ezbookkeeping) ⭐ 5,509 | 🐛 10 | 🌐 Go | 📅 2026-09-01 - A lightweight, self-hosted personal finance and bookkeeping app.
...
* [DNA Claude Analysis](https://github.com/shmlkv/dna-claude-analysis) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2026-03-04 - Interactive personal genome analysis toolkit using Claude Code. Analyzes raw DNA data from 23andMe, AncestryDNA, and others across 17 categories including health risks, pharmacogenomics, nutrition, and longevity.

## Open Source Projects

* [Screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,359 | 🐛 59 | 🌐 Rust | 📅 2026-09-02 - 24/7 local screen and audio recording with AI-powered search. Captures everything you see, say, and hear for personal analytics and lifelogging.
* [Datasette](https://github.com/simonw/datasette) ⭐ 11,417 | 🐛 718 | 🌐 Python | 📅 2026-09-02 - An open source multi-tool for exploring and publishing data.
* [Timelinize](https://github.com/timelinize/timelinize) ⭐ 3,646 | 🐛 56 | 🌐 Go | 📅 2026-05-22 - A data aggregation and and timeline visualization tool.
* [HumanProgrammingInterface](https://github.com/karlicoss/HPI) ⭐ 1,630 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - Unify, acces and interact with all of your personal data.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 164 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-01 - Self-hosted CLI that reads BLE smart scales (23 brands), calculates body composition (fat %, muscle, BMR, etc.), and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. [Website](https://blescalesync.dev).
* [Longevity World Cup](https://github.com/nopara73/LongevityWorldCup) ⭐ 26 | 🐛 186 | 🌐 C# | 📅 2026-09-01 - Open source healthspan competition platform with biological age calculators, athlete profiles, and public leaderboards.
* [lifeos-cli](https://github.com/liujuanjuan1984/lifeos-cli) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Terminal-native LifeOS for personal workflows, habits, and timelogs.
...
* [shenas](https://github.com/shenas-org/shenas) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - Local-first personal analytics platform that ingests health, finance, and activity data into a per-user DuckDB; raw data stays on your device and models train via federated learning.
