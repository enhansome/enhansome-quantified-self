...
* [AirwayLab](https://github.com/airwaylab-app/airwaylab) ⭐ 36 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-13 - Browser-based PAP therapy analysis with flow limitation scoring and an oximetry pipeline. All processing runs locally (Web).
...
* [Firefly III](https://github.com/firefly-iii/firefly-iii) ⭐ 24,509 | 🐛 170 | 🌐 PHP | 📅 2026-09-04 - A free and open source personal finance manager
* [Ledger](https://github.com/ledger/ledger) ⭐ 6,028 | 🐛 18 | 🌐 C++ | 📅 2026-09-05 - Simple but powerful command line accounting.
* [ezBookkeeping](https://github.com/mayswind/ezbookkeeping) ⭐ 5,531 | 🐛 12 | 🌐 Go | 📅 2026-09-05 - A lightweight, self-hosted personal finance and bookkeeping app.
...
* [Screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,428 | 🐛 54 | 🌐 Rust | 📅 2026-09-06 - 24/7 local screen and audio recording with AI-powered search. Captures everything you see, say, and hear for personal analytics and lifelogging.
* [Datasette](https://github.com/simonw/datasette) ⭐ 11,428 | 🐛 717 | 🌐 Python | 📅 2026-09-02 - An open source multi-tool for exploring and publishing data.
* [Timelinize](https://github.com/timelinize/timelinize) ⭐ 3,651 | 🐛 56 | 🌐 Go | 📅 2026-05-22 - A data aggregation and and timeline visualization tool.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 167 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-05 - Self-hosted CLI that reads BLE smart scales (23 brands), calculates body composition (fat %, muscle, BMR, etc.), and exports to Garmin Connect, MQTT, InfluxDB, Webhook, and Ntfy. [Website](https://blescalesync.dev).
* [Longevity World Cup](https://github.com/nopara73/LongevityWorldCup) ⭐ 26 | 🐛 179 | 🌐 C# | 📅 2026-09-05 - Open source healthspan competition platform with biological age calculators, athlete profiles, and public leaderboards.
